...
const generateRandomCoordinates = () => {
  // France: latitude entre 42 et 51, longitude entre -5 et 8
  const lat = 42 + Math.random() * 9; // 42 to 51
  const lng = -5 + Math.random() * 13; // -5 to 8
  return { lat, lng };
};
...
// Noms de villes francaises pour generer les noms de clubs
const CITIES = [
  ...
  'Aix-en-Provence', 'Brest', 'Limoges', 'Tours', 'Amiens', 'Perpignan', 'Metz',
  'Besancon', 'Orleans', 'Mulhouse', 'Rouen', 'Caen', 'Nancy', 'Argenteuil',
];

// Prefixes pour les noms de clubs
const CLUB_PREFIXES = ['Club', 'Association', 'Union', 'Cercle', 'Stade', 'Olympique', 'AS', 'FC', 'RC'];
...
// Mock data - 200 clubs sportifs (a remplacer par vraie data Firestore plus tard)
